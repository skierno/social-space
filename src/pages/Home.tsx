      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <a href="#home" onClick={() => scrollTo("#home")} className="flex items-center gap-3">
            <img src="/logo-full.png" alt="Social Space Logo" width={56} height={56} className="h-14 w-14 rounded-full object-cover object-center" />
  ...
  const packages = [
    {
      ...
      features: [
        ...
        "Basic reporting",
        "Ads Management (Ad budget not included)",
        "Light community management",
        "Professional Shoot Once Every Month Or Two",
      ],
      highlighted: false,
    },
    {
      ...
      features: [
        "6 Reels (Instagram/Facebook/TikTok)",
        "6 Static Posts",
        "Engagement Content",
        ...
        "Influencer Outreach (Influencer fees not included & Charge per influencer)",
        "Professional Shoot Once Every Month",
      ],
      highlighted: true,
    },
    {
      ...
      features: [
          "9 Reels (Instagram/Facebook/TikTok)",
          "9 Static Posts",
          "Engagement Content",
          "Full Content Strategy & Calendar",
          "Full Content Creation & Editing",
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-[#0a1628] rounded-xl p-1.5 border border-[#2563eb]/20">
                <img src="/logo.png" alt="Social Space" width={32} height={32} className="h-8 w-auto" />
              </div>
